(() => {
    ...
    registerLanguage("es", "Castellano", {
        ...
        ui: {
            ...
            usedEvidence: "Evidencia utilizada ({count})", declaredEvidence: "Evidencia declarada legacy ({count})", providerDeclaredSources: "Fuentes declaradas por el proveedor, no comprobadas ({count})", retrievedEvidenceNotUsed: "Evidencia recuperada, no utilizada ({count})",
            retrievedEvidenceBasis: "Evidencia recuperada", providerSearchUnverified: "Búsqueda del proveedor no comprobada", modelKnowledgeBasis: "Conocimiento del modelo",
            evidenceVerified: "citas comprobadas", evidencePartiallyVerified: "citas parcialmente comprobadas", evidenceUnsupported: "sin soporte comprobado", evidenceInvalid: "citas inválidas",
            ...
            provisionalResult: "Resultado provisional", awaitingValidation: "Pendiente",
            waitingEvidence: "Esperando evidencias. Se mostrarán conforme lleguen las validaciones.",
            validationProgressCount: "Respuestas recibidas: {completed}/{total}",
            modelOpinion: "IA: {verdict}", unverifiedCitation: "Cita no verificada",
            opinionExcluded: "No cuenta como voto decisivo en el consenso documental.",
            opinionAudit: "Citas y evidencias proporcionadas", originalModelReason: "Justificación original de la IA",
            citationCheck: "Comprobación de las citas", modelCitations: "Citas devueltas por la IA (sin verificar)",
            providedEvidence: "Evidencias proporcionadas al modelo", auditNotRecorded: "No se registró este detalle en esta validación.",
            citationIssues: { EVIDENCE_TEXT_NOT_RETRIEVED: "La cita no aparece en el texto recuperado", VERDICT_WITHOUT_SUPPORT: "No hay una cita verificada que sostenga el resultado", SOURCE_NOT_RETRIEVED: "La fuente citada no fue recuperada", SOURCE_IS_PLACEHOLDER: "La fuente no contiene evidencia real", URL_REQUIRED: "Falta una URL válida", URL_NOT_RETRIEVED: "La URL citada no coincide con la recuperada", EVIDENCE_TEXT_REQUIRED: "Falta el fragmento citado", INVALID_EVIDENCE_ITEM: "La cita tiene un formato inválido" },
        ...
        llm: {
            protectedAdministration: "Administración protegida", administrationLabel: "Administración LLM",
            configurationTitle: "Configuración LLM", configurationHelp: "Gestiona modelos en caliente y consulta alternativas recomendadas. Las credenciales permanecen en el deployment.",
            refresh: "↻ Refrescar", configurationTab: "Configuración", recommendationsTab: "LLM recomendados",
            components: "Componentes", platformServices: "Servicios de plataforma", configurableServices: "{count} servicios configurables",
            validators: "Validadores", configurationByIdentity: "Configuración por identidad", availableValidators: "{count} disponibles",
            generateAssertions: "Generación de aserciones", sourceRouter: "Router de fuentes",
            generateAssertionsDescription: "Extracción estructurada de afirmaciones verificables", sourceRouterDescription: "Clasificación de dominios y autoridad de fuentes",
            provider: "Proveedor", model: "Modelo", temperature: "Temperatura", effectiveVersion: "Versión efectiva", applyChanges: "Aplicar cambios",
            selectedValidator: "Validador seleccionado", type: "Tipo", strategy: "Estrategia", version: "Versión", categories: "Categorías", notApplicable: "No aplica",
            effectiveConfiguration: "Configuración efectiva", readOnlyTypeStrategy: "El tipo y la estrategia son de solo lectura.",
            noCategories: "Sin categorías declaradas", selectRegisteredValidator: "Selecciona un validador registrado",
            selectValidatorPlaceholder: "Selecciona una identidad para consultar su configuración…", validatorResolutionHelp: "La identidad, el tipo y el destino interno se resuelven desde el registro de validadores.",
            selectValidator: "Selecciona un validador", selectValidatorHelp: "Se cargará su configuración efectiva antes de permitir cambios.",
            loadingEffectiveConfiguration: "Cargando configuración efectiva…", validatorLoadError: "No se pudo cargar el validador seleccionado.",
            loadingConfiguration: "Cargando configuración LLM…", configurationLoadError: "No se pudo cargar la configuración LLM administrativa.",
            configurationApplied: "Configuración aplicada", configurationApplyError: "No se pudo aplicar la configuración LLM",
            validatorConfigurationApplied: "Configuración del validador aplicada", validatorConfigurationApplyError: "No se pudo aplicar la configuración del validador",
            status: { APPLIED: "APLICADA", ACTIVE: "ACTIVO", PENDING: "PENDIENTE", ERROR: "ERROR", INACTIVE: "INACTIVO", UNKNOWN: "DESCONOCIDO" },
            loadingRecommendations: "Consultando catálogo de modelos recomendados…", recommendationsLoadErrorTitle: "No se pudo consultar el catálogo", recommendationsLoadErrorHelp: "El proveedor de recomendaciones no está disponible en este momento.",
            maxNewsCost: "Coste máximo por noticia", noCostLimit: "Sin límite", recalculateRecommendations: "Recalcular", maxNewsCostHelp: "Presupuesto LLM combinado para una noticia de 5 aserciones; limita también la combinación premium.", invalidNewsCost: "Introduce un coste mayor que cero.",
            deployedCatalog: "Configuración efectiva + catálogo OpenRouter", deployedRecommendationsTitle: "Recomendación por LLM desplegado", deployedRecommendationsHelp: "Un candidato ajustado a cada carga, comparado con el modelo que está ejecutándose ahora.",
            deployedLlm: "LLM desplegado", workloadAndSample: "Uso y muestra", currentModel: "Modelo actual", recommendedModel: "Modelo recomendado", currentCost: "Coste actual", recommendedCost: "Coste recomendado", costDelta: "Incremento / ahorro", reason: "Motivo",
            premiumTier: "Mejor alternativa", premiumTierHelp: "Prioriza capacidad y se adapta al límite", similarTier: "Similar", similarTierHelp: "Alternativa curada priorizando el límite", budgetTier: "Ahorro", budgetTierHelp: "Menor coste; validar función", noTierOption: "No hay una alternativa con precio verificable que respete el límite.",
            component: "Componente", validator: "Validador", inputOutputSample: "{input} entrada · {output} salida", estimatedPerExecution: "estimado por ejecución", currentPriceUnavailable: "Precio actual no disponible",
            newsCostTitle: "Coste estimado por noticia", newsCostSample: "Noticia con 5 aserciones de tamaño medio", newsCostWorkload: "1 generación · 5 validaciones por validador · router solo para RAG local", newsCostCurrent: "configuración actual", newsCostPremium: "escenario premium", newsCostSimilar: "escenario similar", newsCostBudget: "escenario de ahorro", newsCostContextLabel: "Contexto de la estimación", newsCostNoLimit: "Sin límite global aplicado.", newsCostLimit: "Límite global: {cost}. Las combinaciones que lo superan se omiten.", newsCostContext: "Suma la generación de la noticia, cinco ejecuciones de cada validador y cinco clasificaciones del router por cada validador RAG local. Cuando una alternativa no está disponible, conserva el modelo actual. No incluye búsquedas web, caché, razonamiento interno ni descuentos.",
            benchmarkNotice: "Recomendación para benchmark: valida calidad, latencia y compatibilidad del payload real antes de aplicarla en producción.",
            catalog: "Catálogo OpenRouter", recommendedModelsTitle: "Modelos recomendados", recommendedModelsHelp: "Ordenados por relación estimada entre calidad y coste.",
            rank: "#", quality: "Calidad", value: "Valor", context: "Contexto", price: "Precio", estimatedCost: "Coste estimado", inputPerMillion: "Entrada / 1M", outputPerMillion: "Salida / 1M", estimatedPerValidation: "por validación estimada", noRecommendations: "No hay recomendaciones con los filtros actuales.",
            pricingNote: "OpenRouter publica los precios de entrada y salida en USD por token; también se muestran en USD por millón de tokens.",
            estimationNote: "El ranking general asume 1000 tokens de entrada y 250 de salida. La comparación por LLM usa la carga indicada en cada fila; no incluye búsqueda web, caché, razonamiento interno ni descuentos.",
            genericReasonFree: "Buen candidato para pruebas y validaciones de bajo coste; revisa límites y rate limits de modelos gratuitos.", genericReasonHighQuality: "Alta calidad esperada con un coste razonable para validación de aserciones.", genericReasonLowCost: "Coste bajo por token y calidad suficiente para clasificación TRUE/FALSE/UNKNOWN.", genericReasonBalanced: "Buen equilibrio entre coste, contexto disponible y calidad estimada.",
            workloads: { generateAssertions: "Extracción estructurada de aserciones", sourceRouter: "Clasificación estructurada de fuentes", ragExtOnlyOfficial: "Validación RAG · solo fuentes oficiales externas", ragExtOfficialFirst: "Validación RAG · fuentes oficiales primero", ragLocal: "Validación RAG · corpus local", rag: "Validación RAG", search: "Validación con búsqueda online", memory: "Validación por conocimiento del modelo" },
            reasons: { generateAssertions: "Prioriza extracción multilingüe, cobertura de hechos y salida estructurada; debe superar el benchmark de AssertionBatch antes del cambio.", sourceRouter: "Modelo pequeño orientado a alto volumen, con contexto amplio y salida estructurada para clasificar autoridad y jurisdicción.", ragExtOnlyOfficial: "Prioriza razonamiento probatorio y entailment sobre evidencias oficiales; es el uso con mayor impacto y justifica un modelo de gama alta.", ragExtOfficialFirst: "Aporta una familia distinta al ensemble y capacidad alta para distinguir soporte, contradicción y evidencia insuficiente.", ragLocal: "Mantiene diversidad de proveedor y prioriza comprensión multilingüe de documentos locales con salida estructurada.", rag: "Prioriza razonamiento probatorio y grounding; la elección final requiere medir entailment y citas con el corpus del proyecto.", search: "Equilibra síntesis y coste para búsqueda online; las citas siguen siendo no verificadas hasta persistir las anotaciones del proveedor.", memory: "Prioriza calibración y coste moderado: un modelo más caro no corrige la falta de evidencia verificable de este tipo de validador." }
        },
        summary: {
            verified: "Verificada",
            ...
            noConsensusOne: "sin consenso",
            noConsensusMany: "sin consenso",
            insufficientOne: "sin evidencia suficiente",
            insufficientMany: "sin evidencia suficiente",
            noResponsesOne: "sin respuestas válidas",
            noResponsesMany: "sin respuestas válidas",
        ...
        decision: {
            trueConsensus: "Verdadero — consenso de los validadores decisivos",
            falseConsensus: "Falso — consenso de los validadores decisivos",
            trueMajority: "Verdadero — mayoría ponderada",
            falseMajority: "Falso — mayoría ponderada",
            noConsensus: "No concluyente — sin consenso",
            insufficientEvidence: "No concluyente — evidencia insuficiente",
            noValidResponses: "No concluyente — sin respuestas válidas",
            inconclusive: "No concluyente",
            winnerShare: "{percent} del peso decisivo",
            tieReason: "TRUE y FALSE acumulan el mismo peso",
            lowCoverageReason: "Solo el {percent} del peso completado emitió una decisión TRUE/FALSE",
            noDecisiveReason: "Las validaciones completadas se abstuvieron o no aportaron peso decisivo",
            allFailedReason: "Ninguna validación completada pudo utilizarse",
            noCompletedReason: "Todavía no hay validaciones completadas utilizables",
            counts: "Decisivas: {decisive} · abstenciones: {abstentions} · errores: {errors}",
            weight: "peso",
            ofDecisiveWeight: "del peso decisivo",
            abstentionWeight: "peso de abstención",
            ofCompletedWeight: "del peso completado",
            completedWeight: "Peso completado",
            noConsensusShort: "sin consenso",
            insufficientShort: "sin evidencia suficiente",
            noResponsesShort: "sin respuestas válidas"
        },
        status: {
        ...
        eventActions: {
            generate_assertions: "Generación de aserciones solicitada",
            assertions_generated: "Aserciones generadas",
            assertions_not_generated: "No se pudieron generar las aserciones",
            upload_ipfs: "Publicación en IPFS solicitada",
            ipfs_uploaded: "Documento publicado en IPFS",
            register_blockchain: "Registro en blockchain solicitado",
            blockchain_registered: "Registro en blockchain completado",
            request_validation: "Validación solicitada",
            validation_requested: "Validación solicitada",
            light_validation_request: "Validación LIGHT solicitada",
            validation_completed: "Validación recibida",
            light_validation_completed: "Validación LIGHT recibida"
        },
        messages: {
            ...
            verificationElapsed: "{date} · {count} s transcurridos · Último evento recibido: {event}",
            verificationNoEvents: "Esperando el primer evento",
            verificationUnknownEvent: "Actualización de la orden",
            verificationEventAssertion: "{event} · Aserción {id}",
    ...
    registerLanguage("en", "English", {
        ...
        ui: {
            ...
            usedEvidence: "Evidence used ({count})", declaredEvidence: "Legacy declared evidence ({count})", providerDeclaredSources: "Provider-declared, unverified sources ({count})", retrievedEvidenceNotUsed: "Retrieved, unused evidence ({count})",
            retrievedEvidenceBasis: "Retrieved evidence", providerSearchUnverified: "Unverified provider search", modelKnowledgeBasis: "Model knowledge",
            evidenceVerified: "verified citations", evidencePartiallyVerified: "partially verified citations", evidenceUnsupported: "no verified support", evidenceInvalid: "invalid citations",
            ...
            provisionalResult: "Provisional result", awaitingValidation: "Pending",
            waitingEvidence: "Waiting for evidence. It will appear as validations arrive.",
            validationProgressCount: "Responses received: {completed}/{total}",
            modelOpinion: "AI: {verdict}", unverifiedCitation: "Unverified citation",
            opinionExcluded: "Does not count as a decisive vote in documentary consensus.",
            opinionAudit: "Citations and provided evidence", originalModelReason: "Original AI explanation",
            citationCheck: "Citation checks", modelCitations: "AI citations (unverified)",
            providedEvidence: "Evidence provided to the model", auditNotRecorded: "This detail was not recorded for this validation.",
            citationIssues: { EVIDENCE_TEXT_NOT_RETRIEVED: "The quote is absent from the retrieved text", VERDICT_WITHOUT_SUPPORT: "No verified citation supports the verdict", SOURCE_NOT_RETRIEVED: "The cited source was not retrieved", SOURCE_IS_PLACEHOLDER: "The source contains no real evidence", URL_REQUIRED: "A valid URL is missing", URL_NOT_RETRIEVED: "The cited URL differs from the retrieved URL", EVIDENCE_TEXT_REQUIRED: "The quotation is missing", INVALID_EVIDENCE_ITEM: "The citation format is invalid" },
        ...
        llm: {
            protectedAdministration: "Protected administration", administrationLabel: "LLM administration",
            configurationTitle: "LLM Configuration", configurationHelp: "Manage models at runtime and review recommended alternatives. Credentials remain in the deployment.",
            refresh: "↻ Refresh", configurationTab: "Configuration", recommendationsTab: "Recommended LLMs",
            components: "Components", platformServices: "Platform services", configurableServices: "{count} configurable services",
            validators: "Validators", configurationByIdentity: "Configuration by identity", availableValidators: "{count} available",
            generateAssertions: "Assertion generation", sourceRouter: "Source router",
            generateAssertionsDescription: "Structured extraction of verifiable assertions", sourceRouterDescription: "Domain classification and source authority",
            provider: "Provider", model: "Model", temperature: "Temperature", effectiveVersion: "Effective version", applyChanges: "Apply changes",
            selectedValidator: "Selected validator", type: "Type", strategy: "Strategy", version: "Version", categories: "Categories", notApplicable: "Not applicable",
            effectiveConfiguration: "Effective configuration", readOnlyTypeStrategy: "Type and strategy are read-only.",
            noCategories: "No categories declared", selectRegisteredValidator: "Select a registered validator",
            selectValidatorPlaceholder: "Select an identity to inspect its configuration…", validatorResolutionHelp: "Identity, type and internal destination are resolved from the validator registry.",
            selectValidator: "Select a validator", selectValidatorHelp: "Its effective configuration will load before changes can be made.",
            loadingEffectiveConfiguration: "Loading effective configuration…", validatorLoadError: "Could not load the selected validator.",
            loadingConfiguration: "Loading LLM configuration…", configurationLoadError: "Could not load the administrative LLM configuration.",
            configurationApplied: "Configuration applied", configurationApplyError: "Could not apply the LLM configuration",
            validatorConfigurationApplied: "Validator configuration applied", validatorConfigurationApplyError: "Could not apply the validator configuration",
            status: { APPLIED: "APPLIED", ACTIVE: "ACTIVE", PENDING: "PENDING", ERROR: "ERROR", INACTIVE: "INACTIVE", UNKNOWN: "UNKNOWN" },
            loadingRecommendations: "Loading recommended model catalog…", recommendationsLoadErrorTitle: "Could not load the catalog", recommendationsLoadErrorHelp: "The recommendations provider is currently unavailable.",
            maxNewsCost: "Maximum cost per news item", noCostLimit: "No limit", recalculateRecommendations: "Recalculate", maxNewsCostHelp: "Combined LLM budget for a 5-assertion news item; it also limits the premium combination.", invalidNewsCost: "Enter a cost greater than zero.",
            deployedCatalog: "Effective configuration + OpenRouter catalog", deployedRecommendationsTitle: "Recommendation by deployed LLM", deployedRecommendationsHelp: "A candidate tailored to each workload, compared with the model currently in use.",
            deployedLlm: "Deployed LLM", workloadAndSample: "Workload and sample", currentModel: "Current model", recommendedModel: "Recommended model", currentCost: "Current cost", recommendedCost: "Recommended cost", costDelta: "Increase / savings", reason: "Reason",
            premiumTier: "Best alternative", premiumTierHelp: "Prioritizes capability and adapts to the limit", similarTier: "Comparable", similarTierHelp: "Curated alternative prioritizing the limit", budgetTier: "Savings", budgetTierHelp: "Lower cost; validate functionality", noTierOption: "No alternative with verifiable pricing can satisfy the limit.",
            component: "Component", validator: "Validator", inputOutputSample: "{input} input · {output} output", estimatedPerExecution: "estimated per execution", currentPriceUnavailable: "Current price unavailable",
            newsCostTitle: "Estimated cost per news item", newsCostSample: "News item with 5 medium-sized assertions", newsCostWorkload: "1 generation · 5 validations per validator · router only for local RAG", newsCostCurrent: "current configuration", newsCostPremium: "premium scenario", newsCostSimilar: "comparable scenario", newsCostBudget: "savings scenario", newsCostContextLabel: "Estimate context", newsCostNoLimit: "No global limit applied.", newsCostLimit: "Global limit: {cost}. Combinations above it are omitted.", newsCostContext: "Adds news generation, five executions of each validator, and five router classifications for each local RAG validator. When an alternative is unavailable, it keeps the current model. Excludes web searches, cache, internal reasoning, and discounts.",
            benchmarkNotice: "Benchmark recommendation: validate quality, latency, and compatibility with the real payload before applying it in production.",
            catalog: "OpenRouter catalog", recommendedModelsTitle: "Recommended models", recommendedModelsHelp: "Sorted by estimated quality-to-cost ratio.",
            rank: "#", quality: "Quality", value: "Value", context: "Context", price: "Price", estimatedCost: "Estimated cost", inputPerMillion: "Input / 1M", outputPerMillion: "Output / 1M", estimatedPerValidation: "per estimated validation", noRecommendations: "No recommendations match the current filters.",
            pricingNote: "OpenRouter publishes input and output pricing in USD per token; it is also shown in USD per million tokens.",
            estimationNote: "The general ranking assumes 1,000 input tokens and 250 output tokens. The per-LLM comparison uses the sample shown in each row; it excludes web search, cache, internal reasoning and discounts.",
            genericReasonFree: "Good candidate for testing and low-cost validation; review limits and rate limits of free models.", genericReasonHighQuality: "Expected high quality at a reasonable cost for assertion validation.", genericReasonLowCost: "Low token cost and sufficient quality for TRUE/FALSE/UNKNOWN classification.", genericReasonBalanced: "Good balance of cost, available context and estimated quality.",
            workloads: { generateAssertions: "Structured assertion extraction", sourceRouter: "Structured source classification", ragExtOnlyOfficial: "RAG validation · external official sources only", ragExtOfficialFirst: "RAG validation · official sources first", ragLocal: "RAG validation · local corpus", rag: "RAG validation", search: "Validation with online search", memory: "Validation from model knowledge" },
            reasons: { generateAssertions: "Prioritizes multilingual extraction, fact coverage and structured output; it must pass the AssertionBatch benchmark before the change.", sourceRouter: "Small model for high-volume workloads, with broad context and structured output to classify authority and jurisdiction.", ragExtOnlyOfficial: "Prioritizes evidential reasoning and entailment over official evidence; this is the highest-impact workload and justifies a high-end model.", ragExtOfficialFirst: "Adds a different model family to the ensemble and high capability to distinguish support, contradiction and insufficient evidence.", ragLocal: "Preserves provider diversity and prioritizes multilingual understanding of local documents with structured output.", rag: "Prioritizes evidential reasoning and grounding; the final choice requires measuring entailment and citations with the project corpus.", search: "Balances synthesis and cost for online search; citations remain unverified until provider annotations are persisted.", memory: "Prioritizes calibration and moderate cost: a more expensive model does not fix this validator type's lack of verifiable evidence." }
        },
        summary: {
            verified: "Verified",
            ...
            noConsensusOne: "without consensus",
            noConsensusMany: "without consensus",
            insufficientOne: "with insufficient evidence",
            insufficientMany: "with insufficient evidence",
            noResponsesOne: "without valid responses",
            noResponsesMany: "without valid responses",
        ...
        decision: {
            trueConsensus: "True — consensus among decisive validators",
            falseConsensus: "False — consensus among decisive validators",
            trueMajority: "True — weighted majority",
            falseMajority: "False — weighted majority",
            noConsensus: "Inconclusive — no consensus",
            insufficientEvidence: "Inconclusive — insufficient evidence",
            noValidResponses: "Inconclusive — no valid responses",
            inconclusive: "Inconclusive",
            winnerShare: "{percent} of decisive weight",
            tieReason: "TRUE and FALSE have the same weight",
            lowCoverageReason: "Only {percent} of completed weight issued a TRUE/FALSE decision",
            noDecisiveReason: "Completed validations abstained or supplied no decisive weight",
            allFailedReason: "No completed validation could be used",
            noCompletedReason: "There are no usable completed validations yet",
            counts: "Decisive: {decisive} · abstentions: {abstentions} · errors: {errors}",
            weight: "weight",
            ofDecisiveWeight: "of decisive weight",
            abstentionWeight: "abstention weight",
            ofCompletedWeight: "of completed weight",
            completedWeight: "Completed weight",
            noConsensusShort: "without consensus",
            insufficientShort: "with insufficient evidence",
            noResponsesShort: "without valid responses"
        },
        status: {
            VALIDATED: "Completed",
            PENDING: "Pending",
        ...
        eventActions: {
            generate_assertions: "Assertion generation requested",
            assertions_generated: "Assertions generated",
            assertions_not_generated: "Assertions could not be generated",
            upload_ipfs: "IPFS publication requested",
            ipfs_uploaded: "Document published to IPFS",
            register_blockchain: "Blockchain registration requested",
            blockchain_registered: "Blockchain registration completed",
            request_validation: "Validation requested",
            validation_requested: "Validation requested",
            light_validation_request: "LIGHT validation requested",
            validation_completed: "Validation received",
            light_validation_completed: "LIGHT validation received"
        },
        messages: {
            ...
            verificationElapsed: "{date} · {count} s elapsed · Latest event received: {event}",
            verificationNoEvents: "Waiting for the first event",
            verificationUnknownEvent: "Order update",
            verificationEventAssertion: "{event} · Assertion {id}",
