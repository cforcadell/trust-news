...
contract HotelBooking {
    ...
    function setIPFShash(string memory hotelName,bytes1   hash_function,bytes1   hash_size,bytes32   digest) public onlyOwner  { 
            require(hotels[hotelName].registered, "Hotel not registered");
            hotels[hotelName].documents.hash_function=hash_function;
            hotels[hotelName].documents.hash_size=hash_size;
            hotels[hotelName].documents.digest= digest;
