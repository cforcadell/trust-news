(() => {
    ...
    registerLanguage("es", "Castellano", {
        ...
        ui: {
            ...
            blockchainHelp: "Validación completa con trazabilidad blockchain e IPFS", lightHelp: "Validación rápida sin publicación en blockchain/IPFS",
    ...
    registerLanguage("en", "English", {
        ...
        ui: {
            ...
            blockchainHelp: "Full validation with blockchain and IPFS traceability", lightHelp: "Fast validation without blockchain/IPFS publication",
