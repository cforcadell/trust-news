(() => {
    ...
    registerLanguage("es", "Castellano", {
        ...
        summary: {
            ...
            completedValidationsWithDuration: "{completed}/{total} validaciones completadas · {consensus} · Tiempo total: {duration}",
    ...
    registerLanguage("en", "English", {
        ...
        summary: {
            ...
            completedValidationsWithDuration: "{completed}/{total} validations completed · {consensus} · Total time: {duration}",
